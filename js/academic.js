...
$('#facultyCSE' ).on( 'click', function () {
	var facultyCSE = {
		faccse1: {
			html:'<div class=""> <div class="grey-box-icon"> <div class="icon-box-top grey-box-icon-pos"> <img src="assets/images/profile/Dr_OP_Verma_CSE.jpg" alt="" width="120" height="140px"/> </div><!--icon box top --> <h4>Dr. O. P. Verma</h4> <h5>Professor, <br> Principal <br> PhD (DU)<br>M, Tech (IIT Delhi)<br> B. E. (MNIT Jaipur) </h5> <p>Specialiazation: Image Processing, Soft Computing, Machine learning, Evolutionary Computing.</p> <a href="mailto:opverma@dce.ac.in" target="_blank">opverma@dce.ac.in	</a> <p><a href="assets/images/Faculty_Profile/CSE/Dr_OP_Verma.pdf"><em>See Profile →</em></a></p> </div><!--grey box --> </div><!--/span3-->',
			buttons: { Cancel: false, Next: true },
			classes: "myclass",
			focus: 1,
			submit:function(e,v,m,f){
...
$('#labECE' ).on( 'click', function () {
  var labece = {
    ...
    labece5: {
      html:'<header> <h1 class="title"> <a href="" style="font-size:32px">Microprocessor I/II Laboratory   : </a> </h1> </header> <div class="clr"></div> <section class="article-body" style="text-align: justify"> <p> is also equipped with 8085/8086 trainer kits, peripheral boards and 8051 trainer kits </p>', 
      buttons: { Back: -1, Next: 1 },
      focus: 1,
      submit:function(e,v,m,f){
        e.preventDefault();
...
$('#labMAE' ).on( 'click', function () {
  var labmae = {
    ...
    labmae6: {
      ...
      labmae7: {
      html:' <header> <h1 class="title"> <a href="" style="font-size:20px">CAD/CAM, CNC LAB  </a> </h1> </header> <div class="clr"></div> <section class="article-body" style="text-align: justify"> <p> has high end Computer systems to support software and machines like Vertical Milling, Turning, Wire cutting and Lathe CNC. </p>', 
      buttons: { Back: -1, Next: 1 },
      focus: 1,
      submit:function(e,v,m,f){
        e.preventDefault();
...
$('#syllabusCSE' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column">Details</a> </th> <th class="item-for"> <a href="#" onclick="Joomla.tableOrdering("a.con_for","asc","");return false;" title="Click to sort by this column">For</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> <th class="item-Date"> <a href="#" onclick="Joomla.tableOrdering("a.date","asc","");return false;" title="Click to sort by this column">Upadte/ Upload Date</a> </th> </tr> </thead> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a>The Syllabus for student of CSE </a> </td> <td class="item-for"> <a>For Old Student</a> </td> <td class="item-Download"> <a href="_/doc/syllabus/cse_syllabus.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Computer Science Engineering ( CSE )</a> </td> <td class="item-position"> <a>The Syllabus for student of Semester 1 and 2 </a> </td> <td class="item-for"> <a>For New Student (Academic Session 2014-15)</a> </td> <td class="item-suburb"> <a href="_/doc/syllabus/Final-Scheme-and-Syllabus-Ist-and-2nd-Semester-for-the-academic-session-2014-15.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Computer Science Engineering ( CSE )</a> </td> <td class="item-position"> <a>The Syllabus for student of Semester 3 to 8 </a> </td> <td class="item-for"> <a>For New Student (Academic Session 2014-15)</a> </td> <td class="item-suburb"> <a href="_/doc/syllabus/Final-Syllabus-CSE-3rd-Semester-4th-5th-6th-7th-8th.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> </table>';
	$.prompt( text, { submit: function ( e, val, $elem ) {
	      	return true;
	      }, buttons: { Close: true } });   
});
...
$('#syllabusECE' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column">Details</a> </th> <th class="item-for"> <a href="#" onclick="Joomla.tableOrdering("a.con_for","asc","");return false;" title="Click to sort by this column">For</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> <th class="item-Date"> <a href="#" onclick="Joomla.tableOrdering("a.date","asc","");return false;" title="Click to sort by this column">Upadte/ Upload Date</a> </th> </tr> </thead> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Electronics & Communication Engineering ( ECE )</a> </td> <td class="item-Details"> <a>The Syllabus for student of ECE </a> </td> <td class="item-for"> <a>For Old Student</a> </td> <td class="item-Download"> <a href="_/doc/syllabus/ece_syllabus.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Electronics & Communication Engineering ( ECE )</a> </td> <td class="item-position"> <a>The Syllabus for student of Semester 1 and 2 </a> </td> <td class="item-for"> <a>For New Student (Academic Session 2014-15)</a> </td> <td class="item-suburb"> <a href="_/doc/syllabus/Final-Scheme-and-Syllabus-Ist-and-2nd-Semester-for-the-academic-session-2014-15.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Electronics & Communication Engineering ( ECE )</a> </td> <td class="item-position"> <a>The Syllabus for student of Semester 3 to 8 </a> </td> <td class="item-for"> <a>For New Student (Academic Session 2014-15)</a> </td> <td class="item-suburb"> <a href="_/doc/syllabus/Final-Syllabus-ECE-3rd-Semester-4th-5th-6th-7th-8th.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> </table>';
...
$('#syllabusMAE' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column">Details</a> </th> <th class="item-for"> <a href="#" onclick="Joomla.tableOrdering("a.con_for","asc","");return false;" title="Click to sort by this column">For</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> <th class="item-Date"> <a href="#" onclick="Joomla.tableOrdering("a.date","asc","");return false;" title="Click to sort by this column">Upadte/ Upload Date</a> </th> </tr> </thead> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a>The Syllabus for student of MAE </a> </td> <td class="item-for"> <a>For Old Student</a> </td> <td class="item-Download"> <a href="_/doc/syllabus/mae_syllabus.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-position"> <a>The Syllabus for student of Semester 1 and 2 </a> </td> <td class="item-for"> <a>For New Student (Academic Session 2014-15)</a> </td> <td class="item-suburb"> <a href="_/doc/syllabus/Final-Scheme-and-Syllabus-Ist-and-2nd-Semester-for-the-academic-session-2014-15.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-position"> <a>The Syllabus for student of Semester 3 to 8 </a> </td> <td class="item-for"> <a>For New Student (Academic Session 2014-15)</a> </td> <td class="item-suburb"> <a href="_/doc/syllabus/Final-Syllabus-MAE-3rd-Semester-4th-5th-6th-7th-8th.pdf" target="_blank">PDF</a> </td> <td class="item-Date"> <a>01-07-2014</a> </td> </tr> </tbody> </table>';
...
$('#timetableCSE' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column">Details</a> </th> <th class="item-date"> <a href="#" onclick="Joomla.tableOrdering("a.date","asc","");return false;" title="Click to sort by this column">Update Date</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> </tr> </thead> <tbody> <!-- New Code starts here --> <tr class="cat-list-row0"> <td class="item-title"> <a href="">  Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a>CSE Time table effective from 24 January 2017</a> </td> <td class="item-date"> <a href="#">23-Jan-2017</a> </td> <td class="item-Download"> <a href="/_/doc/time-table/Updated 2017-Time-Table-CSE-23-1-2017.pdf" target="_blank"> Download PDF File</a> </td> </tr> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a>CSE Time table effective from 9 January 2017</a> </td> <td class="item-date"> <a href="#">23-Dec-2016</a> </td> <td class="item-Download"> <a href="/_/doc/time-table/2017-Time-Table-CSE-23-12-2016.pdf" target="_blank"> Download PDF File</a> </td> </tr> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a>Updated CSE Time table effective from 22 August 2016 </a> </td> <td class="item-date"> <a href="#">19 Aug 2016</a> </td> <td class="item-Download"> <a href="_/doc/time-table/Updated 2016-Time-Table-CSE-22-08-2016.pdf" target="_blank"> Download PDF File</a> </td> </tr> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE ) </a> </td> <td class="item-Details"> <a> Updated CSE Time table effective from 8 August 2016 </a> </td> <td class="item-date"> <a href="#"> 8 Aug 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/Updated 2016-Time-Table-CSE-08-08-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE ) </a> </td> <td class="item-Details"> <a> CSE Time table effective from 1 August 2016 </a> </td> <td class="item-date"> <a href="#"> 29 July 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-CSE-29-07-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE ) </a> </td> <td class="item-Details"> <a> Updated CSE Time table effective from 18 January 2016 </a> </td> <td class="item-date"> <a href="#"> 18 February 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-CSE-effective-from-18-01-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> <!-- New Code ends here --> <tr class="cat-list-row0" style="background-color: #f9f9f9;"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE ) </a> </td> <td class="item-Details"> <a> Updated CSE Time table effective from 16 February 2015 </a> </td> <td class="item-date"> <a href="#"> 13th FEB 2015 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-CSE-effective-from-16-02-2015.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a> Updated CSE Time table effective from 09 February 2015</a> </td> <td class="item-date"> <a href="#"> 06th FEB 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-CSE-06-02-2015.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a>The Time Table of  Computer Science Engineering ( CSE )</a> </td> <td class="item-date"> <a href="#">29th Jan 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-CSE-29-01-2015.pdf" target="_blank">Download PDF File</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href=""> Computer Science Engineering ( CSE )</a> </td> <td class="item-Details"> <a>The Time Table of  Computer Science Engineering ( CSE )</a> </td> <td class="item-date"> <a href="#">1st Jan 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-CSE.pdf" target="_blank">Download PDF File</a> </td> </tr> </tbody> </table>'; 
	$.prompt( text, { submit: function ( e, val, $elem ) {
  		return true;
  	}, buttons: { Close: true } });   
});
...
$('#timetableMAE' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column">Details</a> </th> <th class="item-date"> <a href="#" onclick="Joomla.tableOrdering("a.date","asc","");return false;" title="Click to sort by this column">Update Date</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> </tr> </thead> <!-- New Code Start here --> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a> Updated 2017-Time-Table-MAE-10-1-2017</a> </td> <td class="item-date"> <a href="#"> 10th Jan 2017</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2017-Time-Table-MAE-10-1-2017.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a> Updated 2016-Time-Table-MAE-08-08-2016 </a> </td> <td class="item-date"> <a href="#"> 8th Aug 2016</a> </td> <td class="item-Download"> <a href="_/doc/time-table/Updated 2016-Time-Table-MAE-08-08-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a> MAE Time table effective from 1 August 2016</a> </td> <td class="item-date"> <a href="#"> 29th Jul 2016</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-MAE-29-07-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a> Updated MAE Time table effective from 7 March 2016</a> </td> <td class="item-date"> <a href="#"> 16th Mar 2016</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-MAE-effective-from-07-03-2016.pdf.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#">Mechanical & Automation Engineering ( MAE )        </a> </td> <td class="item-Details"> <a>Updated MAE Time table effective from 15 February2016 </a> </td> <td class="item-date"> <a href="#">26th Feb 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-MAE-effective-from-15-02-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <!-- New Code Ends here --> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Mechanical & Automation Engineering ( MAE ) </a> </td> <td class="item-Details"> <a> Updated MAE Time table effective from 16 February 2015 </a> </td> <td class="item-date"> <a href="#"> 13th Feb 2015 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-MAE-effective-from-16-02-2015.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a> Updated MAE Time table effective from 09 February 2015</a> </td> <td class="item-date"> <a href="#"> 06th Feb 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-MAE-06-02-2015.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#">Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a>The Time Table of Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-date"> <a href="#">29th Jan 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-MAE-29-01-2015.pdf" target="_blank">Download PDF File</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#">Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-Details"> <a>The Time Table of Mechanical & Automation Engineering ( MAE )</a> </td> <td class="item-date"> <a href="#">1st Jan 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-MAE.pdf" target="_blank">Download PDF File</a> </td> </tr> </tbody> </table>';
...
$('#timetableECE' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column"> Details</a> </th> <th class="item-date"> <a href="#" onclick="Joomla.tableOrdering("a.date","asc","");return false;" title="Click to sort by this column">Update Date</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> </tr> </thead> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Electronics & Communication Engineering(ECE) </a> </td> <td class="item-Details"> <a> ECE Time table effective from 2 Sept 2016 </a> </td> <td class="item-date"> <a href="#"> 7th Sept 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/Updated 2016-Time-Table-ECE-2-9-16.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Electronics & Communication Engineering (ECE) </a> </td> <td class="item-Details"> <a> ECE Time table effective from 1 August 2016 </a> </td> <td class="item-date"> <a href="#"> 29th July 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-ECE-29-07-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Electronics & Communication Engineering (ECE) </a> </td> <td class="item-Details"> <a> Updated ECE Time table effective from 18 January 2016 </a> </td> <td class="item-date"> <a href="#"> 24th Feb 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-ECE-effective-from-18-01-2016.pdf" target="_blank"> Download PDF File</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Electronics & Communication Engineering (ECE) </a> </td> <td class="item-Details"> <a> Updated ECE Time table effective from 16 February 2015 </a> </td> <td class="item-date"> <a href="#"> 13th Feb 2015 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-ECE-effective-from-16-02-2015.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Electronics & Communication Engineering (ECE)</a> </td> <td class="item-Details"> <a> Updated ECE Time table effective from 09 February 2015</a> </td> <td class="item-date"> <a href="#"> 06th Feb 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-ECE-06-02-2015.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#">Electronics & Communication Engineering (ECE)</a> </td> <td class="item-Details"> <a>The Time Table of Electronics & Communication Engineering (ECE)</a> </td> <td class="item-date"> <a href="#">29th Jan 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-ECE-29-01-2015.pdf" target="_blank">Download PDF File</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#">Electronics & Communication Engineering (ECE)</a> </td> <td class="item-Details"> <a>The Time Table of Electronics & Communication Engineering (ECE)</a> </td> <td class="item-date"> <a href="#">1st Jan 2015</a> </td> <td class="item-Download"> <a href="_/doc/time-table/2015-Time-Table-ECE.pdf" target="_blank">Download PDF File</a> </td> </tr> </tbody> </table>';
...
$('#timetableHAS' ).on( 'click', function () {
	var text= '<table class="category table table-striped table-bordered"> <thead> <tr> <th class="item-title"> <a href="#" onclick="Joomla.tableOrdering("a.name","asc","");return false;" title="Click to sort by this column">Course Name</a> </th> <th class="item-Details"> <a href="#" onclick="Joomla.tableOrdering("a.con_Details","asc","");return false;" title="Click to sort by this column">Details</a> </th> <th class="item-Date"> <a href="#" onclick="Joomla.tableOrdering("a.con_Date","asc","");return false;" title="Click to sort by this column">Date</a> </th> <th class="item-Download"> <a href="#" onclick="Joomla.tableOrdering("a.Download","asc","");return false;" title="Click to sort by this column">Download</a> </th> </tr> </thead> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Humanities and Applied Sciences </a> </td> <td class="item-Details"> <a> Time Table for 1st Year Students of Applied Sciences effective from 1 August 2016 </a> </td> <td class="item-date"> <a href="#"> 29th July 2016 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/2016-Time-Table-HAS-29-07-2016.pdf" target="_blank"> Download PDF File </a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="#"> Humanities and Applied Sciences </a> </td> <td class="item-Details"> <a> Updated Time Table for 1st Year Students of Applied Sciences effective from 16 February 2015 </a> </td> <td class="item-date"> <a href="#"> 13th Feb 2015 </a> </td> <td class="item-Download"> <a href="_/doc/time-table/ First-year-time-table-effective-from-16-02-2015.pdf" target="_blank"> Download PDF File</a> </td> </tr> </tbody> <tbody> <tr class="cat-list-row0"> <td class="item-title"> <a href="">Humanities and Applied Sciences</a> </td> <td class="item-Details"> <a>The Time Table of 1st Year Students of Applied Sciences</a> </td> <td class="item-Date"> <a>1st Jan 2015</a> </td> <td class="item-Download"> <a href="#" target="_blank">PDF</a> </td> </tr> </tbody> </table>'; 
	$.prompt( text, { submit: function ( e, val, $elem ) {
